...
import { BASE_URL, MENU_ENDPOINTS } from "../../api/endpoints";
...
export const fetchMenuItems = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      const res = await fetch(`${BASE_URL}${MENU_ENDPOINTS.LIST}`);
...
export const fetchMenuItemById = createAsyncThunk(
  ...
  async (id, { rejectWithValue }) => {
    try {
      const res = await fetch(`${BASE_URL}${MENU_ENDPOINTS.SINGLE(id)}`);
      const json = await res.json();
      if (!res.ok) return rejectWithValue(json);
      return json.data;
    } catch (err) {
...
export const fetchRestaurants = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      const res = await fetch(`${BASE_URL}${MENU_ENDPOINTS.RESTAURANTS}`);
      const json = await res.json();
      if (!res.ok) return rejectWithValue(json);
      return json.data;
    } catch (err) {
...
export const fetchCategories = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      const res = await fetch(`${BASE_URL}${MENU_ENDPOINTS.CATEGORIES}`);
      const json = await res.json();
      if (!res.ok) return rejectWithValue(json);
      return json.data;
    } catch (err) {
...
export const createMenuItem = createAsyncThunk(
  ...
  async (formValues, { dispatch, getState, rejectWithValue }) => {
    try {
      ...
      const res = await fetch(`${BASE_URL}${MENU_ENDPOINTS.CREATE}`, {
        method: "POST",
...
export const updateMenuItem = createAsyncThunk(
  ...
  async ({ id, formValues }, { dispatch, getState, rejectWithValue }) => {
    try {
      ...
      const res = await fetch(`${BASE_URL}${MENU_ENDPOINTS.UPDATE(id)}`, {
        method: "PATCH",
        headers: { Authorization: `Bearer ${token}` },
        body,
      });
...
export const deleteMenuItem = createAsyncThunk(
  ...
  async (id, { dispatch, getState, rejectWithValue }) => {
    try {
      const token = getState().auth.accessToken;
      const res = await fetch(`${BASE_URL}${MENU_ENDPOINTS.DELETE(id)}`, {
        method: "DELETE",
        headers: { Authorization: `Bearer ${token}` },
      });
